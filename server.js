...
var gameTypes = [
    { name: 'Repello', url: 'games/repo/game.html', code: './games/repo/repo_logic.js', minPlayers: 1, maxPlayers: 6, config: { matchLength: { value: 3, name: 'Match length', min: 1, max: 100 }, startMagnets: { value: 2, name: 'Start magnets', min: 1, max: 10 } } },
